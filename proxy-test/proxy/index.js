 ...
 * @param config.passthru - boolean, if no file is found the operation will complete without returning a response so execution can be passed to the next async middleware.
 *
